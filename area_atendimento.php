            ...
            <div class="col">
                <nav class="navbar bg-light fixed-top">
                    ...
                    <div class="row">
                        ...
                        <div class="col"><h2 class="cafe" href="#" style="vertical-align: baseline;">BookCoffee</h2></div>
                    </div>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                            ...
                            <div class="offcanvas-body">
                                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                    <li class="nav-item">
                                        <a class="nav-link" href="#">ABRIR COMANDA</a>
                                    </li>
                                    <li class="nav-item">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="row row-cols-12 col-lg-12 row-cols-md-2 g-8">
                            <div class="col">
                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                ...
                                                <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#cardapio">ABRIR COMANDA</button>
                            ...
                            <div class="col">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <span id="status"></span>
                                        <center>
                                        <button type="button" id="bot" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#cardapio">
                                                ABRIR COMANDA
                                        </button>
                                        </center>
                                    </div>
                            ...
                            <div class="col">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <span id="status"></span>
                                        <center>
                                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#cardapio">
                                                ABRIR COMANDA
                                        </button>
                                        </center>
                                    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">ABRIR COMANDA</h5>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-outline-warning">Fechar comanda</button>
