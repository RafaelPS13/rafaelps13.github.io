                ...
                <nav class="navbar bg-light fixed-top">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <h2 class="cafe" href="#" style="vertical-align: baseline;">BookCoffee</h2>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="row row-cols-12 col-lg-12 row-cols-md-2 g-8">
                            ...
                            <?php
                                ...
                                $sql = "SELECT cod_mesa FROM mesas";
                            ...
                            <div class="col">
                                <div class="card mb-3" style="max-width: 540px;">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="https://previews.123rf.com/images/aksenovayu/aksenovayu1510/aksenovayu151000041/47191025-wine-and-candles-on-the-table-and-chair-silhouette-silhouette-of-a-table-in-a-cafe-table-with-wine-a.jpg"
                                                class="card-img-top" alt="mesa01">
                                        </div>

                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo "mesa ". $row['cod_mesa']; ?></h5>
                                                <!-- STATUS DA MESA -->
                                                <span id="status"></span>
                                                <center>
                                                    ...
                                                    <button type="button" class="btn btn-outline-secondary"
                                                        ...
                                                        data-bs-target="#cardapio">Reservar</button>
